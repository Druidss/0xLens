/**
 * AIDigestCard - AI 每日摘要卡片
 * AI Daily Digest Card Component
 *
 * 展示 AI 生成的每日 BTC 行情摘要、关键价位和交易建议
 * Display AI-generated daily BTC market digest, key levels and trading suggestions
 */
...
export function AIDigestCard({
  ...
  return (
    <div
      className="glass-card p-6 rounded-lg transition-all duration-250 hover:shadow-lg hover:-translate-y-1 cursor-pointer"
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="text-right">
          <p className="text-xs text-[var(--text-muted)]">更新时间 / Updated</p>
      ...
      {isExpanded && detailedAnalysis && (
        <div className="mt-4 p-4 bg-[var(--bg-secondary)] rounded-lg animate-in slide-in-from-top duration-250">
          <h4 className="text-sm font-semibold text-[var(--text-primary)] mb-2">
